...
dependencies {
    implementation("com.github.Asutosh11:Bingo:1.0.11")
...
```swift
dependencies: [
    .package(url: "https://github.com/Asutosh11/Bingo.git", from: "1.0.11")
]
```
...
```ruby
pod 'BingoSDK', :git => 'https://github.com/Asutosh11/Bingo.git', :tag => '1.0.11'
```

### Option 3: Manual Framework

1. Download the latest release from: `https://github.com/Asutosh11/Bingo/releases/tag/1.0.11`
